...
export default defineMessages({
  ...
  main: {
    ...
    defaultMessage: 'If the transaction you are searching for was just broadcast it might take a few minutes for the network to pass it around for us to see it.',
  },
  secondary: {
    id: 'app.components.NoOmniBlockTransactions.secondary',
    defaultMessage: 'If the transaction you are searching for is a Bitcoin only transaction you should use a bitcoin block explorer like {link}',
    values: {
