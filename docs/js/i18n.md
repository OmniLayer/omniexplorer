...
export default defineMessages({
  ...
  authorMessage: {
    ...
    defaultMessage: `
      Made with love by {author} supported by {guarda_url}.
    `,
  },
});
```
...
You will also notice a more complex use of `FormattedMessage` for the author message where alternate or variable values (i.e. `author: <A href="https://author-url.com">author name</A>,`) are being injected, in this case it's a react component.
