...
1. Open [localhost:3000](http://localhost:3000) to see it in action.
    ...
    - Edit the file at `./app/components/Header/index.jsx` so that the text of
...
*(If they do have to be changed, please [submit an issue](https://github.com/OmniLayer/omniexplorer/issues)!)*
